package com.saf.Dan.accomodation;
...
public class UploadData extends AppCompatActivity {
    ...
    String Storage_Path = "Accomodation/";

    // Root Database Name for Firebase Database.
    String Database_Path = "Room";

    Button ChooseButton, UploadButton;
    EditText ImageName,descee,pricee;
    Spinner roomType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.update_activity_upload_data);
        ...
        descee=findViewById(R.id.desci);
        pricee=findViewById(R.id.pric);
        ...
        roomType = findViewById(R.id.animalType);
            ...
            storageReference2nd.putFile(FilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            final String roomType1 = roomType.getSelectedItem().toString();
                            final String price = pricee.getText().toString().trim();
                            final String desc = descee.getText().toString().trim();
                                ...
                                if (taskSnapshot.getMetadata().getReference() != null) {
                                    ...
                                    result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            ImageUploadInfo imageUploadInfo = new ImageUploadInfo(TempImageName, roomType1, imageUrl,price,desc);
