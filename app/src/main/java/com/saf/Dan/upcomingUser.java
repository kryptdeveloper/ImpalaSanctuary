...
public class upcomingUser extends Fragment {
    ...
    EventsListener upcomingEventListAdapter ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_upcoming_user, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        upcomingEventListAdapter = new EventsListener(eventDataArrayList,context);
