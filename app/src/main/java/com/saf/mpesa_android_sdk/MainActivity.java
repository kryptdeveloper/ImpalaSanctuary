...
import com.saf.mpesa.Mpesa;
import com.saf.mpesa.interfaces.AuthListener;
import com.saf.mpesa.interfaces.MpesaListener;
import com.saf.mpesa.models.STKPush;
import com.saf.mpesa.models.STKPush.Builder;
...
public class MainActivity extends AppCompatActivity implements AuthListener, MpesaListener {
    ...
    public static final String CONSUMER_KEY = "dV3Lef2nnhcHB8e4jhGA2V0Zjru4J6Hi";
    public static final String CONSUMER_SECRET = "qvsHLkjJGUcwoH83";
    ...
    private void pay(String phone, int amount){
        dialog.show();
        Builder builder = new Builder(BUSINESS_SHORT_CODE, PASSKEY, amount,BUSINESS_SHORT_CODE, phone);
